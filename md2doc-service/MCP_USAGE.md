...
服务将在 `http://localhost:8080` 启动，MCP 端点为 `http://localhost:8080/dataReport/md2doc`。
      ...
      server:
        transport:
          sse:
            ...
            path: /dataReport/md2doc # SSE 端点路径
...
1. 确认服务已启动: `curl http://localhost:8080/dataReport/md2doc`
2. 检查防火墙设置
3. 查看服务日志
