...
public class Md2docMcpTools {
    ...
    public ToolCallback convertMarkdownText() {
        return FunctionToolCallback.builder("convertMarkdownText", new java.util.function.Function<ConvertTextRequest, ConvertResponse>() {
            @Override
            public ConvertResponse apply(ConvertTextRequest request) {
    ...
    public ToolCallback convertMarkdownFile() {
        return FunctionToolCallback.builder("convertMarkdownFile", new java.util.function.Function<ConvertFileRequest, ConvertResponse>() {
            @Override
            public ConvertResponse apply(ConvertFileRequest request) {
                ConvertResponse result = new ConvertResponse();
    ...
    public ToolCallback getSupportedFeatures() {
        return FunctionToolCallback.builder("getSupportedFeatures", new java.util.function.Function<GetFeaturesRequest, FeaturesResponse>() {
            @Override
            public FeaturesResponse apply(GetFeaturesRequest input) {
